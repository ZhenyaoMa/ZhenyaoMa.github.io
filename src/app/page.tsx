...
export default function Home() {
  ...
  const aboutPage = pagesToShow.find((page): page is Extract<PageData, { type: 'about' }> => page.type === 'about');
  const heroSection = aboutPage?.sections.find(section => section.type === 'markdown' && section.id === 'about')
    || aboutPage?.sections.find(section => section.type === 'markdown');
  ...
  return (
    <div className="page-shell home-shell">
      <Profile
        ...
        bioContent={heroSection?.content || ''}
      />

      <div className="home-sections">
        {pagesToShow.map((page) => (
          <section key={page.id} id={page.id} className="page-section-anchor">
            {page.type === 'about' && page.sections.map((section: SectionConfig) => {
              if (section === heroSection) return null;
